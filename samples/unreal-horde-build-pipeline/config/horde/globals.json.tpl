{
  "_comment": [
    ...
    "    the Type/platform-based mapping the validated pipeline actually used - AnyAgent -> sync-pool",
    ...
    "",
    "CONFIRMED against a live Horde 5.5 server (UE5.5.4 end-to-end run):",
    "  1. Pool condition expression syntax works (validated as \"OSFamily == 'Windows'\"; the pools",
    "     below now select by instance tag - \"aws-tag == 'Horde_Autoscale_Pool:<Pool>'\").",
    "  2. The live 5.5 server reads this flat top-level (version 1) schema.",
    "  3. -Script= paths (Build/HydratePipeline.xml, Build/BuildPipeline.xml) resolve correctly",
