...
output "perforce_admin_username_secret_arn" {
  description = "ARN of the secret containing Perforce admin username"
  value       = module.perforce.p4_server_admin_username_secret_arn
}

output "perforce_admin_password_secret_arn" {
  description = "ARN of the secret containing Perforce admin password"
