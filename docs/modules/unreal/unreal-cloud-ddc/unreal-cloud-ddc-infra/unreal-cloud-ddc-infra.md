...
Think of this as defining where your worker bees can live. Each subnet you specify in this variable becomes a potential home for your EKS nodes. Want more flexibility in node placement? Simply add more subnets to the list.

<br/>

ScyllaDB Instance Distribution: `scylla_subnets`

This is where the magic of data distribution happens. For each subnet you specify, the module deploys a ScyllaDB instance. When you configure two or more subnets, these instances automatically form a cluster, working together to ensure your derived data is both resilient and highly available.
