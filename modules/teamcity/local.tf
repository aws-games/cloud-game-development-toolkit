locals {
  ...
  efs_file_system_arn = var.efs_id != null ? data.aws_efs_file_system.efs_file_system[0].id : aws_efs_file_system.teamcity_efs_file_system[0].id
  ...
  base_env = [
    ...
    # if you also want your logs stored in EFS uncomment the below block
    # {
