...
| <a name="input_ecs_agents"></a> [ecs\_agents](#input\_ecs\_agents) | n/a | <pre>map(object({<br>    image         = string<br>    desired_count = number<br>    cpu           = number<br>    memory        = number<br>  }))</pre> | `{}` | no |
