output "p4_server_connection_string" {
  value       = "ssl:${local.perforce_subdomain}.${local.fully_qualified_domain_name}:1666"
...
output "p4_code_review_url" {
  value       = "https://${local.p4_code_review_subdomain}.${local.perforce_subdomain}.${local.fully_qualified_domain_name}"
  description = "The URL for the P4 Code Review service."
}

output "p4_auth_admin_url" {
  value       = "https://${local.p4_auth_subdomain}.${local.perforce_subdomain}.${local.fully_qualified_domain_name}/admin"
