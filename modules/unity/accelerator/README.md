...
| [aws_vpc_endpoint.ec2messages_vpce](https://registry.terraform.io/providers/hashicorp/aws/5.89.0/docs/resources/vpc_endpoint.html) | resource |
| [aws_vpc_endpoint.ssm_vpce](https://registry.terraform.io/providers/hashicorp/aws/5.89.0/docs/resources/vpc_endpoint.html) | resource |
| [aws_vpc_endpoint.ssmmessages_vpce](https://registry.terraform.io/providers/hashicorp/aws/5.89.0/docs/resources/vpc_endpoint.html) | resource |
...
| <a name="input_cloudwatch_log_retention_in_days"></a> [cloudwatch\_log\_retention\_in\_days](#input\_cloudwatch\_log\_retention\_in\_days) | The log retention in days of the cloudwatch log group for Unity Accelerator. | `number` | `356` | no |
...
| <a name="input_unity_accelerator_cache_port"></a> [unity\_accelerator\_cache\_port](#input\_unity\_accelerator\_cache\_port) | The port to reach the Unity Accelerator cache, used by the Unity client. | `number` | `10080` | no |
...
| <a name="input_unity_accelerator_dashboard_port"></a> [unity\_accelerator\_dashboard\_port](#input\_unity\_accelerator\_dashboard\_port) | The port to reach the Unity Accelerator dashboard. | `number` | `80` | no |
...
| <a name="input_unity_accelerator_persist"></a> [unity\_accelerator\_persist](#input\_unity\_accelerator\_persist) | Directory where unity-accelerator.cfg resides as well as other persisted data. | `string` | `"/agent"` | no |
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | The ID of the VPC in which the service will be deployed. | `string` | `null` | no |
<!-- BEGIN_TF_DOCS -->
## Requirements
