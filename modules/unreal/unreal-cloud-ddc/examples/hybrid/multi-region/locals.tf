locals {
  ...
  # Predictable cluster names
  primary_cluster_name   = "${local.project_prefix}-${local.environment}-unreal-cloud-ddc-cluster-${local.primary_region}"
  secondary_cluster_name = "${local.project_prefix}-${local.environment}-unreal-cloud-ddc-cluster-${local.secondary_region}"
